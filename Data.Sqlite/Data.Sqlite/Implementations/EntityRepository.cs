...
using static Data.Sqlite.Manager.SqliteManager;

namespace Data.Sqlite.Implementations
{
...
";
        ...
        void SaveEntities(
          SqliteManager.eSaveData_Process Process
            ...
            var EntityKeys =
                Keys
                    .Select(O_Key =>
                    {
                        ...
                        {
                            FieldName = $"IfNull({FieldName},{NullDefaultIndex})";
                        }
